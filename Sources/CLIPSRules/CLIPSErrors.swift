...
public struct CLIPSAssertStringError: LocalizedError {
    ...
    public let kind: CLIPSAssertStringError.Kind
...
public enum CLIPSPutSlotError: LocalizedError {
    case noError
    case nullPointer
    case invalidTarget
    case slotNotFound
    ...
    static func from(_ err: CLIPSCore.PutSlotError) -> CLIPSPutSlotError {
        switch err {
    ...
    public var errorDescription: String? { "CLIPSPutSlotError: \(self)" }
}

public enum CLIPSLoadError: LocalizedError {
    case noError
    case openFileError
    case parsingError
    case other(CLIPSCore.LoadError)

    static func from(_ err: CLIPSCore.LoadError) -> CLIPSLoadError {
        switch err {
...
public enum CLIPSInstanceBuilderError: LocalizedError {
    case noError
    case nullPointer
    case classNotFound
    case couldNotCreate
    ...
    static func from(_ err: CLIPSCore.InstanceBuilderError) -> CLIPSInstanceBuilderError {
        switch err {
...
public enum CLIPSFactBuilderError: LocalizedError {
    case noError
    case nullPointer
    ...
    static func from(_ err: CLIPSCore.FactBuilderError) -> CLIPSFactBuilderError {
        switch err {
    ...
    public var errorDescription: String? { "CLIPSFactBuilderError: \(self)" }
}

public enum CLIPSFunctionCallBuilderError: LocalizedError {
    case noError
    case nullPointer
    ...
    static func from(_ err: CLIPSCore.FunctionCallBuilderError) -> CLIPSFunctionCallBuilderError {
        switch err {
    ...
    public var errorDescription: String? { "CLIPSFunctionCallBuilderError: \(self)" }
}
...
public enum CLIPSRetractError: LocalizedError {
    ...
    static func from(_ err: CLIPSCore.RetractError) -> CLIPSRetractError {
        switch err {
...
public enum CLIPSGetSlotError: LocalizedError {
    ...
    static func from(_ err: CLIPSCore.GetSlotError) -> CLIPSGetSlotError {
        switch err {
...
public enum CLIPSUnmakeInstanceError: LocalizedError {
    ...
    static func from(_ err: CLIPSCore.UnmakeInstanceError) -> CLIPSUnmakeInstanceError {
        switch err {
...
public enum CLIPSAddUDFError: LocalizedError {
    ...
    static func from(_ err: CLIPSCore.AddUDFError) -> CLIPSAddUDFError {
        switch err {
